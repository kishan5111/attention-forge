...
- **Why KV Cache Eats Your GPU Memory**
- **MHA, MQA, and GQA From Scratch**
- **MLA: Latent KV Cache Without The Mystery**
- **DeepSeek Sparse Attention From Scratch**
- **Dense vs Sparse Attention On Toy Retrieval**
- **From PyTorch Attention To A Tiny Triton Kernel**

## Project Principle

Correct, readable references come first. Benchmarks and kernels come after the
behavior is clear.

Every optimized path should be backed by a small reference implementation,
tests, and measurements that explain what changed.
